...
if(MIDI){
     ...
     myBus.sendControllerChange(1, 1, rollMIDI); // Send a Midi noteOn
     myBus.sendControllerChange(1, 2, pitchMIDI); // Send a Midi noteOn
     myBus.sendControllerChange(1, 3, yawMIDI); // Send a Midi noteOn
     }
...
if(MIDI){   
     ...
     myBus.sendControllerChange(1, 4, rollMIDI); // Send a Midi noteOn
     myBus.sendControllerChange(1, 5, pitchMIDI); // Send a Midi noteOn
     myBus.sendControllerChange(1, 6, yawMIDI); // Send a Midi noteOn
    }
...
if(MIDI){   
     ...
     myBus.sendControllerChange(1, 7, rollMIDI); // Send a Midi noteOn
     myBus.sendControllerChange(1, 8, pitchMIDI); // Send a Midi noteOn
     myBus.sendControllerChange(1, 9, yawMIDI); // Send a Midi noteOn
    }
...
if(OpenSoundControl){ 
  ...
  case EMG:  
      ...
      if (MIDI){
        ...
        myBus.sendControllerChange(1, 11+i, emgMIDI[i]);}
  }
     ...
     if (MIDI) {
      ...
      myBus.sendControllerChange(1, 10, intensityMIDI); // Send a 
      }
