...
private:
    ...
    //==============================================================================
    ScopedPointer<ToggleButton> orQuaternion;
    ScopedPointer<ToggleButton> orRaw;
    ScopedPointer<ToggleButton> orScaled;
    ScopedPointer<ToggleButton> orAcceleration;
    ScopedPointer<ToggleButton> orVelocity;
